        ...
        <title>Registration</title>
         ...
         <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet">
            <style> body{ 
              ...
              <body>
                     <div class="form-card">
                         <form action="reg_action.php" method="POST" autocomplete="off">
                             <fieldset>
                                 <legend>Smart Note </legend> 
                                        <div class="mb-3"> 
                                    <label for="na" class="form-label"> Name</label>
                                                                                    
                                        <input type="text" class="form-control" name="name" id="na" placeholder="Your name..." maxlength="20" required>
                                    </div> 
                                    <div class="mb-3"> 
                                ...
                                <div class="mb-3"> <label for="pa" class="form-label"> Password</label> 
                                ...
                                </div> <button type="submit" class="btn btn-primary w-100"> Register </button> 
                                <p>have an account? <a href="log.php ">login</a></p> </fieldset>
 </form>
